...
const includes = {
            ...
            <script type="text/javascript">
                ...
                // 			req.term = StrLib.trimSpecialChar(req.term);
                            ...
                            request.done(function (responseObj, statusText, xhr) {
                                ...
                                $("#serviceShortcutText").css("display", "none");
                ...
                // 	$("#top-topQuery").keyup(	function(e){ $(this).val(StrLib.trimSpecialChar($(this).val())) });

                    $("#top-findSearchData").on('click', function() {
                ...
                <div class="header_main_area">
                    ...
                    <div class="header_area">
                        <div class="header_title_area">
                            <a href="/cm" title="메인화면 이동"><h1><img src="../mobile/include/images/logo_main_work24.svg" alt="고용24"></h1></a><!-- 23/12/04 퍼블: (시범운영) 추가 -->
                        ...
                        <div class="header_util_area">
                            <ul>
                                ...
                                <li class="header_btn_search">
                                    ...
                                    <div class="search_layer" style="display: none; z-index:190;">
                                        ...
                                        <div class="search_bar">
                                            <input type="text" placeholder="검색어를 입력하세요" id="top-topQuery" maxlength="150" title="검색어 입력" onkeydown="f_keyCheck()" class="ui-autocomplete-input" autocomplete="off">
                                ...
                                <li class="header_btn_all_menu">
                                    <button type="button" onclick="ui.call_layer_all_menu('#layer_all_menu')"><span class="blind">전체메뉴</span></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="header_sub_area">
                    ...
                    <h2 class="sub_title">
                        <strong>졸업생 특화프로그램</strong>
                        <button type="button" class="submenu_open_icon btn_submenu">
                    ...
                    <div class="sub_menu_list" style="display: none;">
                        <ul>
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020000000057', '/b/a/1110/retriveIntroPost.do')">졸업생 특화프로그램</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020000000077', '/u/b/1000/seniorChgJobSptSvcPost.do')">중장년내일센터</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020020105030', '/g/b/1100/busiIntroPost.do')">청년도전지원사업</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020020105001', '/v/a/1000/youngGrowIntroPost.do')">청년성장프로젝트</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020020105031', '/v/a/1000/workPlaceIntroPost.do')">직장적응지원</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020000000081', '/a/i/1110/weSchEmpConsltRoomSvcInvitePost.do')">우리학교 취업지원실</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020020106001', '/w/a/1000/centerListPost.do')">재학생 맞춤형 고용서비스</a>
                            </li>
                        
                            <li>
                                <a href="javascript:void(0);" title="페이지 이동" onclick="fn_goPageUrl('/wk', 'EBG020020107001', '/m/m/0200/retrieveMasBusiIntroPost.do')">중장년 경력지원제</a>
                            </li>
    ...
    bottom_bar: `
        <ul>
            <li>
                <a href="javascript:void(0);" title="정책/제도"
                    onclick="fn_goPageUrl('/cm', 'EBG020000001645', '/c/f/1100/selecPolicyListPost.do', 'EBM02', 'N', '')"
                    class="bottom_bar_job_center">
                    <i></i>
                    <span>정책/제도</span>
                </a>
            </li>
            <li>
                <a href="javascript:void(0);" title="통합검색"
                    onclick="$('#untySearchFlag').val('bottom');javascript:$('.search_open').click(); return false;"
                    class="bottom_bar_btn_search">
                    <i></i>
                    <span>통합검색</span>
                </a>
            </li>
            <li>
                <a href="/cm" title="메인화면 이동" class="bottom_bar_home active">
                    <i></i>
                    <span>홈</span>
                </a>
            </li>
            <li>
                <a href="javascript:void(0);" title="이용안내"
                    onclick="location.href='/cm/c/d/0180/retrieveSiteEasyHpcm.do?tabIndex=tab-panel-01&amp;tabSubIndex=ul_p01';"
                    class="bottom_bar_chatbot">
                    <i></i>
                    <span>이용안내</span>
                </a>
            </li>
            <li>
                <a href="javascript:void(0);" title="페이지 이동"
                    onclick="fn_goPageUrl('/cm', 'EBG020000001564', '/z/b/0210/openLginPagePost.do', 'EBG02', 'N', 'ZB0210M00')"
                    class="bottom_bar_customer_center">
                    <i></i>
                    <span>로그인</span>
                </a>
            </li>
    ...
    ` ,
    paging: `
        <ul><li class="pagingBtn"><button type="button" class="first" onclick="fn_Move(1); return false;"><span class="blind">처음으로 가기</span></button></li><li class="pagingBtn"><button type="button" class="prev" onclick="fn_Move(1); return false;"><span class="blind">이전</span></button></li><li class="on"><button type="button" title="1 페이지 이동" aria-current="true">1</button></li><li><button type="button" onclick="fn_Move(2); return false;" title="2 페이지 이동">2</button></li><li><button type="button" onclick="fn_Move(3); return false;" title="3 페이지 이동">3</button></li><li><button type="button" onclick="fn_Move(4); return false;" title="4 페이지 이동">4</button></li><li><button type="button" onclick="fn_Move(5); return false;" title="5 페이지 이동">5</button></li><li class="pagingBtn"><button type="button" class="next" onclick="fn_Move(6); return false;"><span class="blind">다음</span></button></li><li class="pagingBtn"><button type="button" class="last" onclick="fn_Move(12106); return false;"><span class="blind">마지막으로 가기</span></button></li></ul>
    `
};
